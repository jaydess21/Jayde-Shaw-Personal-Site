    ...
    <div name='skills' className='w-full h-screen bg-[#ff99cc] text-black-300'>
      ...
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
          <div className=' w-full flex justify-center items-center flex-col mb-7'>
              <p className='text-5xl text-white font-bold inline border-b-4 border-pink-500 text-center '>Skills</p>
              <p className='py-1 text-2xl text-white text-center'>I enjoy learning new things, here's a list of technologies I've worked with during this journey:</p>
          </div> 
